...
<td height="408" width="70%">



<s:form action="kwdowkd90" theme="simple">
...
<tr>
	<th colspan="4" align="center" bgcolor="black"><FONT SIZE="4"  COLOR="white"><B>Update Property</B></FONT></th>
</tr>
<tr>
	<td height="10"></td>
<TR>
...
<TR>
	...
	<td align="left">Plot No/Site No</td>
	<td> <input type="text" name="plotno" value="" size="10" maxlength="10"/></td>
...
<tr>
	...
	<td> <input type="text" name="add1" value="" size="20" maxlength="70"/></td>
...
<tr>
<td><input type="hidden" name="pid" value="<%=session.getAttribute("propertyid") %>">
</td>
</tr>
<TR>
	<td colspan="4" align="center"><s:submit action="updateproperties" value="Update"/>
	&nbsp;
